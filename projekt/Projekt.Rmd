...
```{r league-lm2}
legue_lm2 <- list()
legue_lm2$fit <- lm(League ~ polym(AtBat,Hits,HmRun,Runs,RBI,Walks,Years,CAtBat,CHits,CHmRun,CRuns,CRBI,CWalks,PutOuts,Assists,Salary, degree = 2), data = train)
legue_lm2$predicted <- predict(legue_lm2$fit, test)
table(legue_lm2$predicted, test$League)
```
